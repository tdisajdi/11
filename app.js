  ...
  const generateJobSkills = async (roleName) => {
    ...
    try {
      ...
      const fb = [
        ...
        {id:"job_sense",type:"passive",name:"예리한 감각",icon:"👁️",rarity:"uncommon",mpCost:0,hpCost:0,hpRestore:0,req:{per:20},desc:"주변을 감지한다. PER +8.",aiHint:"감각을 곤두세웁니다.",condition:"always",conditionDesc:"항시 발동",statBoost:{per:8},scenario:sid,jobRole:roleName},
